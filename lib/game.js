...
class Game {
  ...
  drawScore(ctx) {
    ctx.font = '32px Bungee Shade';
    ctx.textAlign = 'center';
    ctx.fillStyle = '#4c4b4b';
    ctx.fillText(`Score: ${this.score}`, 975, 25);
  }
  ...
  drawGameOver(ctx, game) {
    ...
    ctx.fillStyle = '#fff';
    ctx.fillRect(0, 0, 1400, 500);
    ctx.font = '42px Bungee Shade';
    ctx.textAlign = 'center';
    ctx.fillStyle = '#4c4b4b';
    ctx.fillText('Game Over', 700, 225);
    ctx.font = '32px Bungee Shade';
    ctx.fillText(`Score: ${game.score}`, 700, 275);
  }
